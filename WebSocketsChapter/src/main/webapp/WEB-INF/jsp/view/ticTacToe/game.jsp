...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<c:url value="/resources/stylesheet/ticTacToe.css" />" />
        ...
        <script type="text/javascript" language="javascript">
            ...
            $(document).ready(function() {
                ...
                if(!("WebSocket" in window)){
                    modalErrorBody.text('WebSockets are not supported in this browser. Try Internet Explorer 10 or the latest ' +
